...
public class TgOpenApplicationTests {
	...
	public void contextLoads() throws WxPayException {
		 ...
		 * .actName("分享") .mchBillNo(PrimaryGenerater.getTradeNo()) .sendName("测试")
		 * .reOpenid("o7m8PwzG7svqNrNc-xEN4O2APUZo") .clientIp("127.0.0.1")
		 * .remark("分享红包") .wishing("你好红包") .totalAmount(30) .build();
		 * 
